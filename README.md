...
- Execute, two choice 
    1. `docker-compose up -d`. It will create the image, install Oracle on it. it can take some time. and auto background run container
    2. `docker build -t <image name>:<tag> .`. It will create the image and install Oracle on it. it can take some time.
